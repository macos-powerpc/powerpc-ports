...
// Use NSWindow directly - GCC ObjC runtime has issues with subclassing
// canBecomeKeyWindow/canBecomeMainWindow are handled via method swizzling in CocoWin.mm
