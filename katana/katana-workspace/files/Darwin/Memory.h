...
void printActiveInfo(const char*);
void printInactive(const char*);
void printInactiveInfo(const char*);
void printWired(const char*);
void printWiredInfo(const char*);
void printApplication(const char*);
void printApplicationInfo(const char*);
